...
public class FlatLander {
	...
	public FlatLander(int x, int y, FlatLanderType nuronType, FlatLanderRandom generator2, long seed, FlatLand flatland,
	...
	public FlatLander(int x, int y, FlatLanderType nuronType, int xinImage2, int yinImage2, FlatLanderRandom generator2,
			long seed2, FlatLand flatland2, int axon, int direction, int length, int dendrites, int direction2,
...
//		return this.fire;
			...
			this.fire = false;
			return this.fire;
//			double nextDouble = Math.random() * 20;
//			if (nextDouble <= 1) {
//				this.fire = true;
//				return this.fire;
//			}
